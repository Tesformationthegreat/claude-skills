...
description: >
  ...
  RFCs, stakeholder updates, competitive analysis, feature prioritization, roadmaps, go-to-market planning,
  ...
  "prioritize these features", "draft release notes", "write a decision doc", "compare us to competitors",
  ...
  "document this", "turn this into tickets").
---
...
Trigger: User says "prioritize these", "what should we build first", "help me decide what to work on", "backlog grooming", or lists multiple potential features.

**Scoring Definitions (use these consistently):**

- **Impact (1-10):** How much this moves a metric you care about. 10 = doubles revenue or eliminates top churn reason. 5 = noticeable improvement for a segment. 1 = affects fewer than 10 users.
- **Confidence (1-10):** How sure are you about the impact score. 10 = you have data (user interviews, A/B test, support tickets). 5 = strong intuition from adjacent data. 1 = pure guess.
- **Effort (1-10, inverted — 10 = easiest):** How hard to build. 10 = a few hours, one person. 5 = a week, one person. 1 = months, multiple people, new infrastructure.
- **Score = (Impact × Confidence × Effort) / 100.** This produces a 0-10 range.

**Before scoring, force-rank Impact first.** If the user (or you) scores more than half the features at 8+ on Impact, the scoring is broken — everything can't be high impact. Force-rank all features by Impact from highest to lowest before assigning numbers. The top feature gets the highest score, and each subsequent feature must be lower. This prevents the "everything is important" trap that makes prioritization useless.
...
| Feature | Impact | Confidence | Effort | Score | Verdict |
|---------|--------|-----------|--------|-------|---------|
| ... | ... | ... | ... | ... | Do now / Do next / Defer / Kill |

## Reasoning

### Do Now
**[Feature]** — Why this is highest priority. What's the hypothesis?

### Do Next
**[Feature]** — Why this comes second.

### Defer
**[Feature]** — Why not now. What would change this?

### Kill
**[Feature]** — Why this isn't worth doing. Be direct.

## Recommendation
"If I had to pick one thing to ship this week, it would be [X] because [reason]."
```
